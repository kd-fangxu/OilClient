...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private void addTextTab(final int position, String title) {
		...
		tab.setSingleLine();
		// tab.setTextSize(ScreenUtils.dip2px(getContext(), 25));
		addTab(position, tab);
	}
	...
	private void scrollToChild(int position, int offset) {
		...
		int newScrollX = tabsContainer.getChildAt(position).getLeft() + offset;// 变化范围（前一个item.getleft---item.getleft+item.width）
