...
public class AppVersionManager {
	...
	public static void doCheckUpdate(final Context context, final boolean isShowInfo) {
		...
		HttpTool.netRequestNoCheck(context, params, new OnReturnListener() {
			...
			public void onReturn(String jsString) {
				...
				try {
					...
					String update = jObject.getJSONObject("data").getString("update");
					final String downLoadUrl = jObject.getJSONObject("data").getString("downloadUrl");
					if (update.equals("1")) {
						// gengxin
						final CommontitleDialog titleDialog = new CommontitleDialog(context);
						titleDialog.Init("提示", "检测到新版本，是否更新", new onComDialogBtnClick() {
